...
public class VistaTest{
	...
	public void testObtenerCombinacion() {
	...
	public void testMostrarJugada() {
		...
		assertEquals(mensajeEsperado1234N0B0, vista.mostrarJugada(resultadoEntradaJugador1234, jugada1, aciertos1234N0B0));
		assertEquals(mensajeEsperado8620NNNN, vista.mostrarJugada(resultadoEntradaJugador8620, jugada2, aciertos8620NNNN));
		assertEquals(mensajeEsperado51840000, vista.mostrarJugada(resultadoEntradaJugador5184, jugada3, aciertos51840000));
		assertEquals(mensajeEsperado0184NB00, vista.mostrarJugada(resultadoEntradaJugador0184, jugada4, aciertos0184NB00));
		assertEquals(mensajeEsperado28160BBN, vista.mostrarJugada(resultadoEntradaJugador2816, jugada5, aciertos28160BBN));
		assertEquals(mensajeEsperado7408BBBB, vista.mostrarJugada(resultadoEntradaJugador7408, jugada6, aciertos7408BBBB));
		assertEquals(mensajeEsperado3628NBNB, vista.mostrarJugada(resultadoEntradaJugador3628, jugada7, aciertos3628NBNB));
		assertEquals(mensajeEsperado6543BNBN, vista.mostrarJugada(resultadoEntradaJugador6543, jugada8, aciertos6543BNBN));
		assertEquals(mensajeEsperado41850NN0, vista.mostrarJugada(resultadoEntradaJugador4185, jugada9, aciertos41850NN0));
	}
